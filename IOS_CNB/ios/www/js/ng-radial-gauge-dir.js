     ...
     return {
         ...
         link: function (scope, ele, attrs) {
             ...
             */
             ...
             var innerRadius = Math.round((view.width * 130) / 400);
             ...
             var transitionMs = parseInt(attrs.transitionMs) || 5000;
             ...
             */
             ...
             var renderGraduationNeedle = function (value, valueUnit, precision, minLimit, maxLimit) {
                 ...
                 if (typeof value === 'undefined') {
                     ...
                     var needleLen = innerRadius*1.5  - majorGraduationLength - majorGraduationMarginTop;
